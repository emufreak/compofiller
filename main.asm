...
localfailed411: ;keep
	...
	cmp.w #$38,musicPos
	bne edblock409
ctb407: ;Main true block ;keep 
	move.w #$6,effectNumber ; Simple a:=b optimization 
edblock409
	cmp.w #$2,tmp
	bhs edblock417
ctb415: ;Main true block ;keep 
